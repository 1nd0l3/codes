...
def main(args):
    try:
        ...
        start = datetime.now()
        print('=====================================================')
        print('[*] Scanning ' + args.IP + '\nPorts: ' + str(args.sport) + ' - ' + str(args.eport))
        print('=====================================================')
...
if __name__ == "__main__":
    ...
    parser.add_argument('sport',action='store',nargs='?',default=1,help='starting port',type=int)
    parser.add_argument('eport',action='store',nargs='?',default=1024,help='end port',type=int)
    parser.add_argument('-t','--throttle',action='store',help='throttle connection attempts',nargs='?',default=0.25,const=0.05)
